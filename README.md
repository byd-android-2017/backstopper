<img src="backstopper_logo.png"  style="background-color: white; zoom: 25%;"/>
...
throw ApiException.newBuilder()
                  ...
                  .withExtraResponseHeaders(Pair.of("received-email",
                                                    singletonList(payload.email)))
...
public enum MyProjectApiError implements ApiError {
    ...
    */
    ...
    /**
    * Mirrors GENERIC_SERVICE_ERROR for the caller, but will show up in the logs 
    ...
    */
    ...
    // Also a mirror for another ApiError, but includes extra metadata that will 
...
``` java
public static class MyFrameworkExceptionHandlerListener 
